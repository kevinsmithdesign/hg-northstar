...
// import SelectPickerSlider from '../Components/SelectPickerSlider/SelectPickerSlider';
...
// Doesn't work for some reason? pluggin the route in as the prop does put looks kinda messy.
// const office365Icon = 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/2392702/Office%20365.svg';
    ...
    <>
        ...
        <div className="col-xl-12 col-xs-6">
          <div className="d-flex">
            <div className="flex-fill">
              <h1 className="text-white mb-5">My Hosting Plan</h1>
            </div>
            <div className="">
               <Link to="/comingsoon" className="btn btn-outline-light">Upgrade Plan</Link> 
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="row">
        <div className="col-12 mb-5">
          ...
          {/* <h1 className="font-weight-bold">My Products</h1> */}
        </div>
      </div>
